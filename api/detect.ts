...
- НЕ выделяй мелкие украшения: серьги, кольца, тонкие браслеты, тонкие цепочки.
  На полноростовом фото они слишком мелкие, их нельзя вырезать отдельной карточкой.
  Крупные заметные аксессуары (сумка, ремень, шляпа, шарф, очки) — выделяй.
